...
export const MEM_CONSOLIDATE_ROUND_FLOOR_MS = 1_000; // a round always gets at least this long to settle, even when the budget is already spent (tests pass budgetMs=0) // /memory consolidate loops passes while under this — the command runs inside the ~60 s Telegram webhook
